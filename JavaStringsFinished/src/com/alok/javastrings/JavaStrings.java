...
public class JavaStrings {
	...
	public static void main(String[] args) {
	    ...
	    //Format and Concatenating (Joining) Strings 
	    int age = 10;
	    ...
	    String formattedString = String.format("name: %s age: %d income:%.2f expenses: %.2f",name,age,income,expenses); 
